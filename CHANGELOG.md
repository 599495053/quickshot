...
- `powershell -ExecutionPolicy Bypass -File .\scripts\release.ps1 -SkipBuild -SkipInstaller`: `491 passed, 37 subtests passed`, manifest signature fields written.
...
- `python -m pytest -q`: `491 passed, 37 subtests passed`
